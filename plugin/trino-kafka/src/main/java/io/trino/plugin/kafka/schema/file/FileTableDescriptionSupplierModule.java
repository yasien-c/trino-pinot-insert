        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(ContentSchemaProvider.class).annotatedWith(ForKafkaRead.class).to(FileReadContentSchemaProvider.class).in(Scopes.SINGLETON);
        binder.bind(ContentSchemaProvider.class).annotatedWith(ForKafkaWrite.class).to(FileWriteSchemaProvider.class).in(Scopes.SINGLETON);
