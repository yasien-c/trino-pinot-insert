        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        binder.bind(ContentSchemaProvider.class).annotatedWith(ForKafkaRead.class).to(AvroConfluentContentSchemaProvider.class).in(Scopes.SINGLETON);
            ...
            implements Module
    {
        ...
        public void configure(Binder binder)
        {
            ...
            binder.bind(ContentSchemaProvider.class).annotatedWith(ForKafkaWrite.class).to(AvroConfluentContentSchemaProvider.class).in(SINGLETON);
        }
    }
