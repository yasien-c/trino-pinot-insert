...
public class PinotQueryFunctionProvider
        implements Provider<ConnectorTableFunction>
{
    ...
    @Inject
    public PinotQueryFunctionProvider(PinotMetadata metadata, PinotClient client, PinotTypeConverter pinotTypeConverter)
    {
            ...
            extends AbstractConnectorTableFunction
    {
        ...
        public TableFunctionAnalysis analyze(ConnectorSession session, ConnectorTransactionHandle transaction, Map<String, Argument> arguments)
        {
            ...
            Descriptor returnedType = new Descriptor(dynamicTable.getColumnHandlesForSelect()
                    ...
                    .collect(toList()));
            PinotTableHandle tableHandle = new PinotTableHandle(SCHEMA_NAME, dynamicTable.getTableName(), TupleDomain.all(), OptionalLong.empty(), Optional.of(dynamicTable), Optional.empty(), OptionalInt.empty(), Optional.empty());
