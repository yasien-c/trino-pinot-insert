...
public class PinotClient
{
    ...
    private final NonEvictableLoadingCache<Object, ListMultimap<String, String>> allTablesCache;
    ...
    {
        List<String> candidates = getFromCache(allTablesCache, ALL_TABLES_CACHE_KEY).get(trinoTableName.toLowerCase(ENGLISH));
