        ...
        extends AbstractConfigurationAwareModule
{
    ...
    protected void setup(Binder binder)
    {
        ...
        newOptionalBinder(binder, PinotDeepStore.class).setBinding().to(PinotDeepStore.class).in(Scopes.SINGLETON);
    }
    ...
    public static PinotConfiguration getPinotFsConfiguration(PinotGcsConfig config)
    {
        return new PinotConfiguration(
                ImmutableMap.<String, Object>builder()
                        ...
                        .put("storage.factory.gs.projectId", config.getGcpProjectId())
                        .put("storage.factory.gs.gcpKey", config.getGcpKey())
                        .buildOrThrow());
    }
}
