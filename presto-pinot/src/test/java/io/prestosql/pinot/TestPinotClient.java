...
public class TestPinotClient
{
    ...
    public void testBrokersParsed()
    {
        ...
        PinotClient pinotClient = new PinotClient(pinotConfig, new IdentityPinotHostMapper(), new PinotMetrics(), httpClient, newCachedThreadPool(threadsNamed("pinot-metadata-fetcher-testing")), MetadataUtil.TABLES_JSON_CODEC, MetadataUtil.BROKERS_FOR_TABLE_JSON_CODEC, MetadataUtil.TIME_BOUNDARY_JSON_CODEC, MetadataUtil.BROKER_RESPONSE_NATIVE_JSON_CODEC);
