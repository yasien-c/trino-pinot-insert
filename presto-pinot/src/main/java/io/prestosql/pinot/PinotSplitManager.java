        ...
        implements ConnectorSplitManager
{
    ...
    @Inject
    public PinotSplitManager(PinotClusterInfoFetcher pinotClusterInfoFetcher)
    {
        this.pinotClusterInfoFetcher = requireNonNull(pinotClusterInfoFetcher, "pinotClusterInfoFetcher is null");
    }
            ...
            ConnectorSession session)
    {
        ...
        routingTable = pinotClusterInfoFetcher.getRoutingTableForTable(tableName);

        List<ConnectorSplit> splits = new ArrayList<>();
        if (!routingTable.isEmpty()) {
            PinotClusterInfoFetcher.TimeBoundary timeBoundary = pinotClusterInfoFetcher.getTimeBoundaryForTable(tableName);
