...
public class CssPasswordAuthenticatorFactory
        implements PasswordAuthenticatorFactory
{
    @Override
    public String getName()
    {
        return "css-authentication";
    }
    ...
    public PasswordAuthenticator create(Map<String, String> config)
    {
        Bootstrap app = new Bootstrap(
                binder -> {
                    ...
                    binder.bind(CssPasswordAuthenticator.class).in(Scopes.SINGLETON);
        ...
        Injector injector = app
                ...
                .initialize();
        return injector.getInstance(CssPasswordAuthenticator.class);
    }
}
